...
class Net_SHG(nn.Module):
    ...
    def __init__(self, nStack, nHGscales, blockstr, nFeat=32, nModules=1):
        ...
        for i in range(0, nStack):
            ...
            #convout.append(nn.Conv2d(nFeat, 3, kernel_size=3, padding=1))
...
if __name__ == '__main__':
    ...
    p['inputRes'] = (40, 40)  # Input Resolution
    p['outputRes'] = (40, 40)  # Output Resolution (same as input)
    p['g_size'] = 80  # Higher means narrower Gaussian
    ...
    numHGScales = 3  # How many times to downsample inside each HourGlass
    net = Net_SHG(p['numHG'], numHGScales, p['Block'], 128, 1)
